...
Original file is located at
    https://colab.research.google.com/drive/1jnJIVlbjOeGWpssNdcNTIiI4OeLa_AjH
"""
...
for i in range(num_companies):
    ...
    if send_email == 'yes':  # If the user wants to send an email
        ...
        # 8. Create the HTML email content with the embedded image
        body = f"""
        <html>
        <body>
            ...
            <p>Best Regards,<br>
            [Your Name]<br>
            E-Cell VIT, Vellore</p>
            <img src="cid:image1" style="width:150px;height:auto;">  <!-- Embed and resize image -->
        </body>
        </html>
        """
